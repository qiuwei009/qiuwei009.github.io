<template>
  <div class='webFriendship'>
    <div id='webFriendship'>
...
<script name='/webFriendship' setup>
...
onMounted(() => {
  state.getList(null);
  document.getElementById('webFriendship').addEventListener('scroll', (e) => {
    state.animateScroll();
  });
});
...
.webFriendship{
  width:100%;
  height:100%;
  background:url('../../../assets/image/webPagesImage/81893721_p0.jpg') no-repeat;
